...
//  ofxPSBlend.h
//
//  https://raw.githubusercontent.com/Akira-Hayasaka/ofxPSBlend/master/src/ofxPSBlend.h
//
...
public:
    ...
    void draw(ofTexture& blendTgt, ofTexture& blendSrc, int blendMode = 0)
    {
        psBlendShader.begin();
        psBlendShader.setUniformTexture("base", blendSrc, 1);
        psBlendShader.setUniformTexture("blendTgt", blendTgt, 2);
        psBlendShader.setUniform1i("mode", blendMode);
        drawPlane(width, height);
        psBlendShader.end();
